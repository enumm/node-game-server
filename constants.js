...
exports.UnitTypes = {
    Pleb: {        name: 'Pleb',       type: 'ground',  damage: 3, armor: 6,  movementSpeed: 50,   life: 80,  attackSpeed: 1,   range: 15},
        ...
        FlyingPleb2: { name: 'FlyingPleb2',type: 'flying',  damage: 30, armor: 4,  movementSpeed: 80,  life: 80,   attackSpeed: 2,   range: 100},

        Bla: {         name: 'Bla',        type: 'ground', damage: 3, armor: 6, movementSpeed: 50, life: 80, attackSpeed: 1,  range: 15},
        ...
        FlyingBla2: {  name: 'FlyingBla2', type: 'flying', damage: 30, armor: 4, movementSpeed: 80, life: 80, attackSpeed: 2,  range: 100}
};

exports.BuildingTypes = {
    PlebHut : {    name: 'PlebHut',    cost: 5, frame: 3, life: 200, armor: 20, buildTime: 10, unitType: 'Pleb'},
        PlebHut : {    name: 'PlebHut',    cost: 5, frame: 3, life: 200, armor: 20, buildTime: 10, unitType: 'Pleb'},
        ...
        PlebFlying : { name: 'PlebFlying', cost: 25, frame: 4, life: 200, armor: 20, buildTime: 15, unitType: 'FlyingPleb'},
        PlebFlying2 : {name: 'PlebFlying2',cost: 30, frame: 9, life: 200, armor: 20, buildTime: 20, unitType: 'FlyingPleb2'},

        BlaHut : {     name: 'BlaHut',     cost: 5, frame: 3, life: 200, armor: 20, buildTime: 10, unitType: 'Bla'},
        ...
        BlaFlying : {  name: 'BlaFlying',  cost: 25, frame: 4, life: 200, armor: 20, buildTime: 15, unitType: 'FlyingBla'},
        BlaFlying2 : { name: 'BlaFlying2', cost: 30, frame: 9, life: 200, armor: 20, buildTime: 20, unitType: 'FlyingBla2'}
};